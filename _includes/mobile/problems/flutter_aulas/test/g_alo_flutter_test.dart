...
void main() {
  testWidgets('Test 400x200',
    ...
    await expectLater(
        find.byWidget(root), matchesGoldenFile("goldens/g_alo_flutter01.png"));
  });
  ...
  testWidgets('Test 300x500',
    ...
    await expectLater(
        find.byWidget(root), matchesGoldenFile("goldens/g_alo_flutter02.png"));
  });
}
