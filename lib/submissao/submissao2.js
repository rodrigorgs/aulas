...
<form autocomplete="off">
  ...
  addRunCodeHook(function (code, codeMirror) {
    ...
    enviaRespostas(editorIndex, true);
  });
...
function enviaRespostas(question_index = null, silent = false) {
  ...
  const submission = { answer, question_index, submission_type, question_type: "code" };
