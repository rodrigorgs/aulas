...
function fullScreenConsolelog(){
    ...
    $('#fullScreenConsole').off('click');
    $('#fullScreenConsole').on('click', voltaConsolelogAoNormal);
...
function voltaConsolelogAoNormal(){
    ...
    $('#fullScreenConsole').off('click');
    $('#fullScreenConsole').on('click', fullScreenConsolelog);   
    $('#fullScreenConsole').attr('value', 'Expandir');
